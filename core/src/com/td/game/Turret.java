...
public class Turret {
    ...
    public void activate(TurretEmitter.TurretTemplate template, int cellX, int cellY) {
        ...
        this.imageId = template.getImageIndex();
    ...
    //-- improve turret
    public void improveTurret(TurretEmitter.TurretTemplate template) {
        this.range = template.getRadius();
        this.fireDelay = template.getFireRate();
        this.imageId = template.getImageIndex();
        this.damage = template.getDamage();
    ...
    public void render(SpriteBatch batch) {
        batch.draw(regions[imageId], position.x - 40, position.y - 40, 40, 40, 80, 80, 1, 1, angle);
    }
